...
function rotateVec3(v: number[] | undefined, m: THREE.Matrix4, isPoint: boolean): number[] | undefined {
...
export function rotateInertialParams(
...
export function worldAlignJointFrame(
  ...
  const compensation = new THREE.Matrix4()
    .multiplyMatrices(rOld.clone().invert(), rNew)
    .invert()
